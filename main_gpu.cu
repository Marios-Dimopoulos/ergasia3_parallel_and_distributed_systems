...
// =============================================================
    ...
    coloringCC_gpu(nrows, nnz, rowptr, index, labels);  // Call to coloringCC_gpu function. The elapsed time that is measured includes only the execution time of this function.
